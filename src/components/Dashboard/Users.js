...
const handleClickCloseDeleteUser = () => {
  ...
  //  const data = [
  //   { Amount:  "23", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Approved', Role:'Manager', 'Date Created': '12-10-2020',  'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue' }} onClick={handleClickOpenEdit} /> , Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}} onClick={handleClickOpenDeleteUser} /> },
  //   { Amount: "Joe James", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Denied', Role:'Super Admin',  'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}} onClick={handleClickOpenEdit} />,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}}  onClick={handleClickOpenDeleteUser}/>  },
  //   { Amount: "Joe James", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Approved', Role:'Staff', 'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}}  onClick={handleClickOpenEdit}/> ,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}} onClick={handleClickOpenDeleteUser} /> },
  //   { Amount: "Joe James", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Denied', Role:'Staff',  'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}}  onClick={handleClickOpenEdit}/> ,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}}  onClick={handleClickOpenDeleteUser}/> },
  //   { Amount:  "23", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Approved', Role:'Manager', 'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}}  onClick={handleClickOpenEdit}/> ,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}}  onClick={handleClickOpenDeleteUser}/>},
  //   { Amount: "Joe James", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Denied', Role:'Super Admin',  'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}}  onClick={handleClickOpenEdit}/> ,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}}  onClick={handleClickOpenDeleteUser}/> },
  //   { Amount: "Joe James", "Weight (kg)": "Test Corp",  Quantity: "Yonkers", Mortality:'34', Status:'Denied', Role:'Staff',  'Date Created': '12-10-2020', 'Details': <VisibilityIcon  sx={{cursor:'pointer', color:"#012949"}} onClick={handleClickOpen}/>, 'Edit': <EditIcon  sx={{cursor:'pointer', color:'blue'}}  onClick={handleClickOpenEdit}/> ,  Delete: <DeleteIcon  sx={{cursor:'pointer', color:'red'}}  onClick={handleClickOpenDeleteUser}/> },
  //  ];
...
{/* <Autocomplete
    ...
    <br/>
        ...
        <div className="form-group focused" style={{marginRight:10}}>
                  <a href="#!" className="btn btn-success"  style={{backgroundColor:'#012949', }} onClick={UpdateSingleStaff} >Update </a>
...
<div className="form-group focused" style={{marginRight:10}}>
                 ...
                 <div className="form-group focused" style={{marginRight:10}}>
                  <a href="#!" className="btn btn-success"  style={{backgroundColor:'red', }} onClick={()=>dispatch(DeleteStaff())}> Delete </a>
